...
BossChicken::BossChicken(void):Chickens(1)
{
	...
	chickentexture.loadFromFile("images/UFOChicken.png");
	Bosshealth1texture.loadFromFile("images/bossHealthBar1.png");
	Bosshealth2texture.loadFromFile("images/bossHealthBar2.png");
	Bosshealth3texture.loadFromFile("images/bossHealthBar3.png");
	Bosshealth4texture.loadFromFile("images/bossHealthBar4.png");
	...
	hitSoundBuffer.loadFromFile("Sounds/BossHit.wav");
